# Strudel Sound Catalog

Full instrument and sample listings for the strudel skill. Read this when picking specific drum machines, synths, GM instruments, or multi-sampled instruments.

Contents:
- Drum Machines Catalog — Roland, Linn, Oberheim, E-mu, Yamaha, Korg, Boss, Alesis, Sequential, Akai, Casio, Simmons, other gems
- Synthesizers — waveforms, noise, z-oscillators, misc synths
- Wavetables
- GM Instruments — keys, organs, guitars, bass, strings, brass, reeds, pipes, leads, pads, FX
- Samples Catalog — pianos, strings, mallets, winds, organs, percussion (pitched/drums/world/metals/wood), Asian instruments, sound effects
